...
var app = {
    ...
    focusOnKnight: false,
    initKnightsNavBar: function initKnightsNavBar() {
        for (var i = 0, j = this.knights.length; i < j; i++) {
    ...
    animateKnightNavBar: function animateKnightNavBar(knight) {
...
var utils = {
    style: {
        ...
        hasClass: function hasClass(el, searchClass) {
            return el.className.indexOf(searchClass) > -1 ? true : false;
        }
    },
    service: {
        event: {
            registerHandler: function registerHandler(target, type, callback) {
...
},{"core-js/fn/regexp/escape":4,"core-js/shim":298,"regenerator-runtime/runtime":302}],4:[function(require,module,exports){
...
},{"_process":301}],304:[function(require,module,exports){
'use strict';
...
var Promise = require('es6-promise').Promise; /*jshint esversion: 6 */
...
(function (Promise) {
    ...
    ['Seiya', 'Shiryu', 'Hyoga', 'Shun', 'Ikki'].forEach(function (knight) {
        app.knights.push(app.knight.create({
            name: knight,
            styles: {
    ...
    var navBarItems = app.knights,
        ...
        navItemMinHeight = parseInt(_utils.utils.style.getStyle(navBarItems[0].html.navBar, 'min-height')),
        navItemAnimated = false;

    _utils.utils.service.event.registerHandler(window, 'DOMContentLoaded', function () {
        ...
        navBarItems.forEach(function (knight, i) {
            var el = knight.html.navBar;
                ...
                el.addEventListener('click', function () {
                    ...
                    if (!app.animatedKnight) {
                        (function () {
                            ...
                            _utils.utils.service.request.fetch(knightName + '.html').then(_utils.utils.service.request.status).then(_utils.utils.service.request.html).then(function (html) {
        ...
        for (var i = 0, j = links.length; i < j; i++) {
            _utils.utils.service.event.registerHandler(links[i], 'click', function (e) {
                e.preventDefault();
            });
        }

        _utils.utils.service.event.registerHandler(window, 'resize', function () {
...
},{"./app":1,"./utils":2,"babel-polyfill":3,"es6-promise":299,"fetch-ie8":300,"vue":303}]},{},[304]);
